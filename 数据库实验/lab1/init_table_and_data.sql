...
insert into Book value('b4', 'Redis 设计与实现', '黄建宏', 79.0, 1, 4, 0);
insert into Book value('b5', '人类简史', 'Yuval', 68.00, 1, 6, 0);
insert into Book value('b6', '史记 (公版)', '司马迁', 220.2, 1, 5, 0);
insert into Book value('b7', 'Oracle 编程艺术', 'Thomas', 43.1, 0, 4, 0);
insert into Book value('b8', '分布式系统及其应用', '邵佩英', 30.0, 0, 2, 0);
insert into Book value('b9', 'Oracle 管理', '张立杰', 51.9, 0, 5, 0);
...
insert into Book value('b16', '中国 2185', '刘慈欣', 218.5, 1, 7, 0);
insert into Book value('b17', '高性能 MySQL', 'Botros', 20.00, 0, 0, 0);  
